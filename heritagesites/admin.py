...
# registering newly created models Planet and Location

@admin.register(models.Planet)
class PlanetAdmin(admin.ModelAdmin):
	"""
	New class added as a result of Mtg 5 database refactoring. (Planet)
	"""
...
class LocationAdmin(admin.ModelAdmin):
	"""
	New class added as a result of Mtg 5 database refactoring. (Location)
	"""
